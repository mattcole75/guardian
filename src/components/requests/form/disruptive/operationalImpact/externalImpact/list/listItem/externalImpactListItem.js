...
const ExternalImpactListItem = (props) => {

    const { select, toggle, item, index } = props;

    const {
        externalDisruptionTitle, externalDisruptedEventsRequired, externalDisruptedSecurityRequired, externalDisruptionRoadworksRequired,
...
export default ExternalImpactListItem;