...
const ResourceImpactListItem = (props) => {

    const { select, toggle, item, index } = props;

    const {
            resourceDisruptionTitle, resourceDisruptedCarTaxiRequired, resourceDisruptedCSRsRequired, resourceDisruptionWellfareRequired,
            resourceDisruptionPointsOperatorRequired, resourceDisruptionHandSignallerRequired
    } = item;
        ...
        <tr className='border-bottom'>
            <td className='ps-3 pe-3'>
                <div className='table-item_col'>
                    {resourceDisruptionTitle}
                </div>
            </td>
            <td className='ps-3 pe-3'>
                <div>
                    { resourceDisruptedCarTaxiRequired
...
export default ResourceImpactListItem;